import {
  package_default
} from "./chunk-MVIFWT74.js";
import {
  selectSvgElement
} from "./chunk-5UVOOB6E.js";
import {
  isEmpty_default
...
import {
  JSON_SCHEMA,
  load
} from "./chunk-GW6SE322.js";
import {
  registerLayoutLoaders
} from "./chunk-2GJ76TNP.js";
import "./chunk-VIHV2HLA.js";
import "./chunk-L4D7Y4OM.js";
import "./chunk-S56VHXMJ.js";
import "./chunk-X65VLTWV.js";
import "./chunk-HH7FAUZO.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-DWYWDXT7.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-AHM2P6SP.js";
import "./chunk-I6RL7E24.js";
import {
  init_purify_es,
  purify
} from "./chunk-EGGPMNJW.js";
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-6F6E4RAY-QB3DNGHZ.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-PKI6S5ZS-2354RJ66.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-R3QVA2FD-Q3AAAYZ3.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-GW3U2K7C-SNOIUAXP.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-EK5VF46D-3UATCY2A.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-XT3IWWJI-5UR5DP75.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-NIOCPIFQ-DDC4LZXU.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-2OG54O6I-IQ4K6HRL.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-H2YORKM3-TBAWAQBB.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-SO3GGRV7-4YWWUFTU.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-ZIKVLSP4-APAACYJV.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-BGRH5UQR-X7XFT4NZ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-O24JOBDK-QOJP2XCD.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-XX37X6EN-HKP5C6Q5.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-GD6S3NHB-VRVBN6MW.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-EWQZEKCU-YRZX4QY3.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-RI47OAVP-WOS4IAYH.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-CZNETY7S-HCQJYLHQ.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-ILFWEQ3N-Z7GZHY7G.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-4UZDY2LN-ABY7I2AJ.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5UYTHUR4-DQDBPE7M.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-ZTM2IBQH-Y2II5Z4C.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-PHRCVELO-WQHWHH4Z.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-NQ2NVSRB-4YX6FOGT.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-3EMPZRKU-3L7WZ4J2.js");
