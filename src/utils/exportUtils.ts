...
export const exportToHtml = async (htmlContent: string, title: string = 'Nexus Export'): Promise<void> => {
...
<body>
    ...
    <footer style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0; text-align: center; color: #a0aec0; font-size: 0.875rem;">
        Generated by Nexus Markdown Editor
    </footer>
</body>
</html>`;
...
export const exportToPdf = async (element: HTMLElement): Promise<void> => {
  ...
  const options = {
    ...
    filename: `nexus-export-${new Date().toISOString().split('T')[0]}.pdf`,
